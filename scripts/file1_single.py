...
for row in set_of_rows:
    ...
    # print(orbit)
    # if(orbit not in ["43113","43086","43091","43084","43066","43064","43037"]):
    #     continue
    ...
    source_path = f'cztipoc@192.168.11.37:/data2/czti/level2/{date}*level2/czti/orbit/{orbit}/*czt_level2.mkf'#modeM0/*quad_badpix.fits'
    destination_path = f'../../data/evt_files/{orbit}/'

    return_code = fetch_files(source_path, destination_path, None)

    for file in files_needed:
        source_path = f'cztipoc@192.168.11.37:/data2/czti/level2/{date}*level2/czti/orbit/{orbit}/modeM0/*{file}'
        destination_path = f'../../data/evt_files/{orbit}/'
